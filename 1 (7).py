...
#Setting up Images
main_bg = pygame.image.load('lab9/images/racer/main-bg.png') #BG on game over
background = pygame.image.load("lab9/images/racer/bg.png") #BG on playing
...
cars_path = os.path.join(os.getcwd(), 'lab9/images/racer/cars')
cars = list()
for image in os.listdir(cars_path) :
    cars.append(pygame.image.load(f'{cars_path}/{image}'))

#Randomly choosing coin image
coin_images = [pygame.image.load('lab9/images/racer/coin.png'), pygame.image.load('lab9/images/racer/super_coin.png')]
coin_image = coin_images[0]
for i in range(3) :
    coin_images.append(pygame.image.load('lab9/images/racer/coin.png'))


#Setting up Sounds
coin_sound = pygame.mixer.Sound('lab9/sound/coin.mp3')
game_over_theme_sound = pygame.mixer.Sound('lab9/sound/game_over_theme.mp3')
pygame.mixer.music.load('lab9/sound/super_mario.mp3')
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__() 
        self.image = pygame.image.load('lab9/images/racer/cars/car_blue.png')
        self.image = pygame.transform.scale(self.image, (70 ,140))
        self.rect = self.image.get_rect()
...
quit_button_image = pygame.image.load('lab9/images/racer/quit.jpg')
restart_button_image = pygame.image.load('lab9/images/racer/restart.jpg')
