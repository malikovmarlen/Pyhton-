...
seconds = pygame.image.load(get_path('7/screen/big.png'))
minutes = pygame.image.load(get_path('7/screen/small.png'))
seconds = pygame.transform.scale(seconds, (50, 100))
minutes = pygame.transform.scale(minutes, (30, 60))

bg = pygame.image.load(get_path('7/screen/mickey-clock.jpg'))
