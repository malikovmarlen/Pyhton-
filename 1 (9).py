...
#Setting up Images
main_bg = pygame.image.load('lab8/images/main-bg.png') #BG on game over
background = pygame.image.load("lab8/images/bg.png") #BG on playing
bg_height = background.get_height()
tiles = math.ceil(SCREEN_HEIGHT / bg_height) + 1
bg_rect = background.get_rect()
coin_image = pygame.image.load('lab8/images/coin.png')
cars_path = os.path.join(os.getcwd(), 'lab8/images/cars')
cars = os.listdir(cars_path)
scroll = 0

#Setting up Sounds
coin_sound = pygame.mixer.Sound('lab8/sound/coin.mp3')
game_over_theme_sound = pygame.mixer.Sound('lab8/sound/game_over_theme.mp3')
pygame.mixer.music.load('lab8/sound/super_mario.mp3')
...
class Enemy(pygame.sprite.Sprite):
      def __init__(self):
        super().__init__()
        #Random car images
        self.image = pygame.image.load(f'lab8/images/cars/{cars[random.randint(0, len(cars) - 1)]}')
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__() 
        self.image = pygame.image.load("lab8/images/cars/car_red.png")
        self.image = pygame.transform.scale(self.image, (70 ,140))
        self.rect = self.image.get_rect()
...
quit_button_image = pygame.image.load('lab8/images/quit.jpg')
restart_button_image = pygame.image.load('lab8/images/restart.jpg')
