...
#Setting up Sounds
food_sound = pygame.mixer.Sound('lab8/sound/eat.mp3')
...
main_menu_bg_load = pygame.image.load('lab8/images/main_menu_snake.jpg')
main_menu_bg = Button(main_menu_bg_load, 0, 0)
main_menu_play_load = pygame.image.load('lab8/images/play_button_snake.png')
main_menu_play = Button(main_menu_play_load, (screen_width - main_menu_play_load.get_width()) / 2, 300)
main_menu_quit_load = pygame.image.load('lab8/images/quit_button_snake.png')
main_menu_quit = Button(main_menu_quit_load, (screen_width - main_menu_quit_load.get_width()) / 2, 400)
main_menu_restart_load = pygame.image.load('lab8/images/restart_button_snake.png')
